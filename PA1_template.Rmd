...
The mean of total steps is `r steps[1]` and the median is `r steps[2]`.
...
The maximum average number of steps was `r maxsteps` which occurred during interval `r maxinterval`.
...
The total number of rows with missing values is `r tna`.  I will impute the missing values by using the mean for that 5 minute interval averaged across the two months. 
